  ...
  theme: {
  	...
  	extend: {
  		...
  		keyframes: {
  			...
  			'pulse-glow': {
  				'0%, 100%': { boxShadow: '0 0 0 0 hsl(var(--accent) / 0.6), 0 10px 25px -5px hsl(var(--accent) / 0.4)' },
  				'50%': { boxShadow: '0 0 0 10px hsl(var(--accent) / 0), 0 15px 30px -5px hsl(var(--accent) / 0.6)' }
  			},
  			'ping-slow': {
