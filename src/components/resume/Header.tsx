...
const Header = () => {
  ...
  return (
    <header className="relative pb-section-sm border-b border-border">
      ...
      <a
        href="/demo"
        className="group absolute top-0 right-0 z-20 print:hidden inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-primary to-accent text-primary-foreground font-medium text-sm shadow-lg shadow-accent/30 hover:shadow-xl hover:shadow-accent/50 hover:scale-105 transition-all duration-300 animate-pulse-glow"
      >
        <span className="absolute inset-0 rounded-full bg-accent/40 animate-ping-slow opacity-75 pointer-events-none" aria-hidden="true" />
